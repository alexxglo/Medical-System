...
public class System_builder extends FacilityHelper {
    ...
    public Facility buildInitialFacility() {
        ...
        List<String> appointment_typeContainings1 = Arrays.asList("X-Ray", "Prescription if needed");

        List<String> appointment_typeContainings2 = Arrays.asList("Massage", "2 injections", "Blood samples");

        List<String> appointment_typeContainings3 = Arrays.asList("Control", "Vitamin boost", "All Samples");

        List<String> appointment_typeContainings4 = Arrays.asList("Surgery", "Anesthesic", "Hospitalization");

        List<String> appointment_typeContainings5 = Arrays.asList("Anesthesic","Lethal injection");
        ...
        Appointment appointment = new Appointment(1,appointmentPrice_type1+appointmentPrice_type2, Arrays.asList(appointment_type1,appointment_type2)) ;

        Appointment appointment2 = new Appointment(2,appointmentPrice_type3+appointmentPrice_type4, Arrays.asList(appointment_type3,appointment_type4)) ;

        Appointment appointment3 = new Appointment(3,appointmentPrice_type1, Arrays.asList(appointment_type1)) ;

        Appointment appointment4 = new Appointment(4,appointmentPrice_type5, Arrays.asList(appointment_type5)) ;

        Appointment appointment5 = new Appointment(5,appointmentPrice_type2+appointmentPrice_type4, Arrays.asList(appointment_type2,appointment_type4)) ;
        ...
        Employee employee1 = new Employee("Popa","Alex");
